...
namespace MyProject.Admin.Configuration.Constants
{
    public class AuthenticationConsts
    {
        ...
        public const string OidcClientSecret = "MyClientSecret";
        ...
        public const string IdentityAdminApiSwaggerClientId = "MyClientId_api_swaggerui";
        public const string IdentityAdminApiScope = "MyClientId_api";
