...
namespace WebEditorPlugins
{
    ...
    public class KindEditorController : Controller
    {
        ...
        public async Task<IActionResult> SaveFiles(string dir)
        {
            ...
            string physicalFilePath = AppDomain.CurrentDomain.BaseDirectory;// hostingEnv.WebRootPath;
        ...
        public IActionResult FileManager()
        {
            ...
            String dirPath = AppDomain.CurrentDomain.BaseDirectory + "\\" + uploadFilePath + "\\";
